...
def proceso(nombre):
    try:
        ...
        dirtxt='C:/Users/videowall_03/Downloads/'+nombre+'.txt'
        dircsv='C:/Apache24/htdocs/estacionesMet/files/'+nombre+'.csv'
        ...
        fecha_anteayer0= anteayer0 +"/"+ mesanteayer0 +"/"+ añoanteayer0
        ...
        fecha_anteayerc=  "," + anteayer1 +"/"+ mesanteayer1 +"/"+ añoanteayer1
        ...
        texto6=texto5.replace(fecha_anteayer0,fecha_anteayerc)
        texto7=texto6.replace(fecha_ayer0,fecha_ayerc)
        texto8=texto7.replace(fecha_hoy0,fecha_hoyc)
        estacionunam1=open(dirtxt,"w")
        estacionunam1.write(texto8)
        estacionunam1.close()
        estacionunam.close()
