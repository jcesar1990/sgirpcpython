...
#Definimoa la función "proceso" que será llamada como un modulo en el script python.py
...
#Definimoa la función "procesolocal" que será llamada como un modulo en el script python.py
...
#Se eliminaran las primeras lineas del archivo txt
    ...
    try:
        ...
        try:
            ...
            print("No existe el archivo ",dircsv)
#test1=proceso("juarez", "SGIRPC")
test2=procesolocal("Cuajimal", "STFS")